...
@Service
public class AdministratorUserLoginService{
    @Autowired
    private AdministratorUserLoginMapper adminLoginMapper;

    @Autowired
    PasswordEncoder passwordEncoder;

    public UserDetails loadUserByUsername(String username,String password) throws UsernameNotFoundException {
        AdministratorUser user = adminLoginMapper.getUserByName(username);
        if (user!=null) {
